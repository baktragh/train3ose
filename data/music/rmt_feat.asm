;* --------BEGIN--------
;* C:\projects\train3\data\music\train3_stripped.rmt
FEAT_SFX		equ 1
FEAT_GLOBALVOLUMEFADE	equ 0		;RMTGLOBALVOLUMEFADE variable
FEAT_NOSTARTINGSONGLINE	equ 0
FEAT_INSTRSPEED		equ 1
FEAT_CONSTANTSPEED		equ 0		;(77 times)
FEAT_COMMAND1		equ 1		;(84 times)
